...
const STEPS = [
  {
    ...
    description: "Describe your topic and AI generates your interactive presentation in seconds.",
  },
  {
    number: 2,
    icon: QrCode,
    title: "Students scan & join",
    description: "Share a QR code—every phone in the room connects instantly.",
  },
  {
    number: 3,
    icon: Presentation,
    title: "Engaging presentation",
    description: "Live quizzes, polls, and reactions—everyone participates.",
  },
  {
    number: 4,
    icon: BarChart3,
    title: "See the analytics",
    description: "Understand what resonated and how your audience responded.",
  },
];
...
export default function HowItWorks() {
  return (
    ...
    >
      <h2 className="text-xl sm:text-2xl font-display font-bold text-foreground mb-6 sm:mb-8 text-center">
        How it works
      </h2>
