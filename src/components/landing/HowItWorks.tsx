...
const STEPS = [
  ...
  },
  {
    number: 3,
    icon: Presentation,
    title: "Interactive lecture & insights",
    description: "Live quizzes, polls, reactions. The room becomes engaged and memorable. See what worked, who participated, and how your audience responded.",
  },
];
